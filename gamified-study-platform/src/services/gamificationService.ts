...
import { calculateLevelFromXP, calculateCurrentLevelXP, calculateXPToNextLevel } from '../utils/gamification';
    ...
    try {
      ...
      switch (activityType) {
        case 'study_session':
          ...
          break;
        case 'quest_complete':
          xpAmount = difficulty === 'easy' ? 20 : difficulty === 'medium' ? 40 : 60;
          source = 'Quest Completed';
          break;
        case 'todo_complete':
          xpAmount = difficulty === 'easy' ? 5 : difficulty === 'medium' ? 10 : 15;
      ...
      try {
        ...
        await petStore.updateFromStudyActivity(userId, activityType, durationMinutes);
