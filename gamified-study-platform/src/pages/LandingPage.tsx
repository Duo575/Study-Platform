        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gradient">StudyQuest</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Turn studying into an adventure with gamified learning, virtual
            pets, and intelligent progress tracking. Level up your knowledge
            while having fun!
          </p>
        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="card text-center">
            ...
            <p className="text-gray-600">
              Earn XP, level up, and unlock achievements as you study. Make
              learning addictive with our reward system.
            </p>
          </div>
          ...
          <div className="card text-center">
            ...
            <p className="text-gray-600">
              Adopt and care for a virtual pet that grows with your study
              habits. Keep them happy by staying consistent!
            </p>
          </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            <p>
              &copy; 2024 StudyQuest. Built with ❤️ for learners everywhere.
            </p>
          </div>
        </div>
      </footer>
