...
export function useKeyboardNavigation(
  ...
  }, [activeIndex, items, onSelect, isActive, loop, orientation, homeEndKeys, typeahead, typeaheadString])
...
export function useKeyboardShortcuts(shortcuts: Record<string, () => void>, isActive: boolean = true) {
  useEffect(() => {
    if (!isActive) return
