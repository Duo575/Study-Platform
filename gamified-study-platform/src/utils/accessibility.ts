...
export class AccessibilityChecker {
  ...
  checkImageAltText(container: HTMLElement = document.body): AccessibilityIssue[] {
      ...
      if (!img.alt && !img.getAttribute('aria-label') && !img.getAttribute('aria-labelledby')) {
        ...
        if (!isDecorative) {
          issues.push({
            ...
            element: img,
            suggestion: 'If decorative, add role="presentation" or aria-hidden="true"'
          })
        }
      }
    })
  ...
  checkHeadingHierarchy(container: HTMLElement = document.body): AccessibilityIssue[] {
  ...
  checkFormLabels(container: HTMLElement = document.body): AccessibilityIssue[] {
  ...
  checkColorContrast(container: HTMLElement = document.body): AccessibilityIssue[] {
    const issues: AccessibilityIssue[] = []
  ...
  checkKeyboardAccessibility(container: HTMLElement = document.body): AccessibilityIssue[] {
    const issues: AccessibilityIssue[] = []
      ...
      if (ariaLabelledby) {
        ...
        if (!referencedElement) {
          issues.push({
            ...
            element: element as HTMLElement,
            suggestion: 'Ensure referenced element exists and has the correct ID'
          })
        }
      }
