...
export const GamificationDashboard: React.FC<GamificationDashboardProps> = ({
  ...
  if (isLoading) {
    return (
      <div className={`${className} p-4 bg-white dark:bg-gray-800 rounded-lg shadow animate-pulse`}>
  ...
  return (
    <div className={`${className} ${compact ? 'p-2' : 'p-4'} bg-white dark:bg-gray-800 rounded-lg shadow`}>
      ...
      {!compact && (
        ...
        >
          <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg">
            <div className="text-xs text-blue-600 dark:text-blue-400 mb-1">Weekly XP</div>
          ...
          <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg">
            <div className="text-xs text-green-600 dark:text-green-400 mb-1">Study Hours</div>
      ...
      {/* XP Animation */}
      <XPAnimation position={compact ? 'bottom-right' : 'top-right'} />
    </div>
  );
};
