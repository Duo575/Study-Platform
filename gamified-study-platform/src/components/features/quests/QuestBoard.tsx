...
import { Tabs, TabList, Tab, TabPanel } from '../../ui/Tab';
import type {
  Quest,
  QuestType,
  QuestDifficulty,
    ...
    <div className="flex flex-col h-full">
      ...
      >
        <TabList className="mb-4">
          <Tab value="active">Active ({activeQuests.length})</Tab>
          <Tab value="completed">Completed ({completedQuests.length})</Tab>
        </TabList>
        ...
        <TabPanel value="active">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Generate new quests to start your adventure!"
              action={
                <Button
                  onClick={handleGenerateQuests}
                  disabled={isGenerating || courses.length === 0}
        ...
        <TabPanel value="completed">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Complete quests to see them here."
            />
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto pb-4">
